...
export default function PropertyForm({ action, defaultValues = {}, propertyId, slug: initialSlug = '', agents = [] }: Props) {
  ...
  const catalogChecklistInput = useMemo<CatalogPublishChecklistInput>(() => ({
    ...
    descriptionEn: catalogChecklistValues[4],
    cityEs: catalogChecklistValues[5],
    zoneEs: catalogChecklistValues[6],
    lotSurfaceM2: catalogChecklistValues[7] as number | null | undefined,
    totalArea: catalogChecklistValues[8] as number | null | undefined,
    area: catalogChecklistValues[9] as number | null | undefined,
    builtArea: catalogChecklistValues[10] as number | null | undefined,
    totalLots: catalogChecklistValues[11] as number | null | undefined,
    availableLots: catalogChecklistValues[12] as number | null | undefined,
    images,
    coverImage,
