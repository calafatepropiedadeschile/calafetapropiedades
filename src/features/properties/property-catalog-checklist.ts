...
export function getCatalogPublishChecklist(
  ...
  const items: CatalogPublishChecklistItem[] = [
    ...
    },
    {
      ...
      hint: 'Aparece en busqueda del catalogo',
    ...
    },
    {
      ...
      hint: 'Filtro "Tipo" en el catalogo',
    ...
    },
    {
      ...
      hint: 'Filtro por zona y busqueda por ubicacion',
    ...
    },
    {
      ...
      hint: 'Filtro "Superficie minima" del catalogo',
      ok: hasSurface,
      required: false,
    },
    {
      ...
      hint: 'Mejora la busqueda por texto en el catalogo',
